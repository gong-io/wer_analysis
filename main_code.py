...
def get_edit_df(REF_PATH, HYP_PATH, preprocessing_normalization_func=preprocessing_normalization_func, ewer_normalization_func=ewer_normalization_func, limit=None):
    full_compare = []
...
def analyze_wer_folders(folder_truth, folder_hypothesis, folder_output, preprocessing_normalization_func=preprocessing_normalization_func, ewer_normalization_func=ewer_normalization_func):
